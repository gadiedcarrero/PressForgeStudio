...
class Settings(BaseSettings):
    ...
    # Modelos para estilos NO realistas (RealVisXL es fotográfico): el estilo
    # 'anime' usa Animagine y el '3d' (Pixar) usa RealCartoon-XL.
    comfyui_anime_checkpoint: str = "animagine-xl-4.0.safetensors"
    comfyui_3d_checkpoint: str = "realcartoonXL_v6.safetensors"
